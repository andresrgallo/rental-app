...
export default class RentPayments extends Component {
  ...
  rentDates = (startDate, endDate, paymentDay, rent, frequency) => {
    ...
    console.log('payday', paymentDayNumber);
    ...
    console.log('init diff', initDaysDifference);
    ...
    console.log('start first period', firstCompletePeriodDate);
    console.log('end first period', endFirstPeriodDate);
    for (
      let i = 0;
